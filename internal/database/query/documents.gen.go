...
func newDocument(db *gorm.DB, opts ...gen.DOOption) document {
	...
	_document.UserID = field.NewInt64(tableName, "user_id")
	_document.Title = field.NewString(tableName, "title")
	_document.OriginalFilename = field.NewString(tableName, "original_filename")
	_document.FilePath = field.NewString(tableName, "file_path")
	_document.Language = field.NewString(tableName, "language")
	_document.PageCount = field.NewInt32(tableName, "page_count")
	_document.Sha256 = field.NewString(tableName, "sha256")
	_document.UploadedAt = field.NewTime(tableName, "uploaded_at")
...
func (d *document) updateTableName(table string) *document {
	...
	d.OriginalFilename = field.NewString(table, "original_filename")
	d.FilePath = field.NewString(table, "file_path")
	d.Language = field.NewString(table, "language")
	d.PageCount = field.NewInt32(table, "page_count")
	d.Sha256 = field.NewString(table, "sha256")
	d.UploadedAt = field.NewTime(table, "uploaded_at")
...
func (d *document) WithContext(ctx context.Context) IDocumentDo { return d.documentDo.WithContext(ctx) }
...
func (d *document) fillFieldMap() {
	...
	d.fieldMap["original_filename"] = d.OriginalFilename
	d.fieldMap["file_path"] = d.FilePath
	d.fieldMap["language"] = d.Language
	d.fieldMap["page_count"] = d.PageCount
	d.fieldMap["sha256"] = d.Sha256
	d.fieldMap["uploaded_at"] = d.UploadedAt
}
